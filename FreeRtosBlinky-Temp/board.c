...
void Board_LED_Set(LED_colour_t LED, bool On)
{
	...
	if (LED == red) {
		Chip_GPIO_WritePortBit(LPC_GPIO, LED_RED_GPIO_PORT_NUM, LED_RED_GPIO_BIT_NUM, state);
	}
	else if (LED == green)
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LED_GREEN_GPIO_PORT_NUM, LED_GREEN_GPIO_BIT_NUM, state);
	}
	else if (LED ==blue)
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LED_BLUE_GPIO_PORT_NUM, LED_BLUE_GPIO_BIT_NUM, state);
	}
}
...
bool Board_LED_Test(LED_colour_t LED)
{
	...
	if (LED == red) {
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, LED_RED_GPIO_PORT_NUM, LED_RED_GPIO_BIT_NUM);
	}
	else if (LED == green)
	{
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, LED_GREEN_GPIO_PORT_NUM, LED_GREEN_GPIO_BIT_NUM);
	}

	else if (LED == blue)
		{
			state = Chip_GPIO_ReadPortBit(LPC_GPIO, LED_BLUE_GPIO_PORT_NUM, LED_BLUE_GPIO_BIT_NUM);
		}
